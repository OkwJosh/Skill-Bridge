...
# =============================================================================
# The frontend handles Google/Email login via Supabase Auth.
# It passes the Supabase access_token to Django as: Authorization: Bearer <token>
# Django decodes and verifies this JWT using the SUPABASE_JWT_SECRET.
#
...
REST_FRAMEWORK = {
    # Authentication: Use our custom Supabase JWT backend
